...
<body>
	...
	<div class="menu">
		<ul>
			...
			<li><a href="./categorias.php" class="activo">Categorias</a></li>
	...
	<div class="col-sm-12 col-md-6 col-lg-6 mt-3 pt-3 animated fadeIn" style="background: white;">
		...
		<form id="agregar_categoria_form" method="POST">
		  ...
		  <div class="form-group">
		    ...
		    <input type="text" name="nombre" class="form-control" id="Nombre" placeholder="Introdusca un nombre de categoria" required="">
		  </div>
